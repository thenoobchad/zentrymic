...
useEffect(()=>{
  ...
  return (
    <div className="h-dvh relative w-screen overflow-x-hidden">
        ...
        <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
            ...
            <div className="absolute left-0 top-0 z-40 size-full">
                <div className="mt-24 px-5 sm:px-10">
                    ...
                    <p className="mb-5 max-w-64 font-robert-regular font-semibold text-md text-blue-100">Enter the Meta-game Layer<br/> Unleash the Play Economy</p>

                    <Button id="watch-tailer" title="Watch Trailer" leftIcon={<TiLocationArrow />}
        ...
        <h1 className="special-font hero-heading absolute bottom-5 right-5 z-60 text-black">G<b>a</b>ming</h1>
